...
--Totral Seats Won by NDA Alliance
SELECT 
    SUM(CASE 
            WHEN party IN (
...
--Seats won I.N.D.I.A Alliance Parties
SELECT 
    party as Party_Name,
    won as Seats_Won
FROM 
...
--Add new column field in the table partywise_results to get the Party Alliance as NDA, I.N.D.I.A and other
